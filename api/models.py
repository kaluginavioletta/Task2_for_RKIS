...
class Cover(models.Model):
    ...
    cover = models.ImageField(validators=[validate_image], upload_to='cover/books/title', verbose_name='Изображения', blank=True, null=False)
...
class Genre(models.Model):
    name = models.CharField(max_length=100, verbose_name='Название жанра', blank=False)
...
class Category(models.Model):
    name = models.CharField(max_length=100, verbose_name='Название категории', blank=True)
...
class Book(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE, max_length=100, verbose_name='Категория', blank=True)
